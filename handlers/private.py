            ...
            [
                [
                    InlineKeyboardButton(
                        "🎉 𝐁𝐞𝐧𝐢 𝐆𝐫𝐮𝐛𝐚 𝐄𝐤𝐥𝐞 🎉", url=f"https://t.me/Myt_Music_Bot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🇹🇷 𝐀𝐬𝐢𝐬𝐭𝐚𝐧", url="https://t.me/Mytasistant"
                    ),
                    InlineKeyboardButton(
                        "📝 𝐒𝐚𝐡𝐢𝐩", url="https://t.me/meyitzade47"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "📝 𝐊𝐚𝐧𝐚𝐥", url=f"https://t.me/hiraset"
                    )
                ]
